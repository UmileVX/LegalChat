...
from app.services.next_question_suggestion import NextQuestionSuggestion

from .model import ChatData, Message, SourceNodes


logger = logging.getLogger("uvicorn")


class LegalChatStreamResponse(StreamingResponse):
    """
    Class to convert the response from the chat engine to the streaming format expected by LegalChat
    """
    ...
    def __init__(
        ...
        content = LegalChatStreamResponse.content_generator(
